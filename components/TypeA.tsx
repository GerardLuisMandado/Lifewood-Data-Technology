  ...
  const stackSteps: StackStep[] = [
    {
      ...
      title: 'Objective',
      description:
        'Build a production-ready document intelligence pipeline for large-scale, multi-language records with high reliability and consistent output.',
    ...
    },
    {
      ...
      title: 'Result',
      description:
        'Deliver cleaner, structured datasets with faster turnaround, improved quality metrics, and higher model-readiness across document types.',
      image: 'https://images.unsplash.com/photo-1555949963-aa79dcee981c?auto=format&fit=crop&q=80&w=1400'
    }
  ];
  ...
  return (
    <div className="bg-[#FCFBF7]">
      <section className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-2 items-center gap-12 bg-[#F3EFDE] rounded-[3rem] p-16 relative overflow-hidden">
          <div className="relative z-10">
            <h1 className="text-7xl font-black text-[#133020] uppercase tracking-tighter mb-8 leading-none">
              Type A -
              <br />
              Data Servicing
            </h1>
            <p className="text-xl text-[#666666] font-medium leading-relaxed max-w-md mb-10">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <h2 className="text-4xl font-black text-[#133020] uppercase tracking-tighter mb-12">TYPE A- DATA SERVICING</h2>

        <div className="grid lg:grid-cols-[minmax(0,1fr)_minmax(0,560px)] gap-14 items-start">
          <div>
            <ScrollStack
