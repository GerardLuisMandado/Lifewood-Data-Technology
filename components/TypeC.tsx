...
const TypeC: React.FC = () => {
  ...
  const stackSteps: StackStep[] = [
    ...
    },
    {
      ...
      title: 'Solutions',
      description:
        'Deliver vertical LLM and computer-vision datasets for smart cockpit, driver monitoring, and transportation intelligence using multi-sensor and multilingual annotation pipelines.',
      image: 'https://images.unsplash.com/photo-1483478550801-ceba5fe50e8e?auto=format&fit=crop&q=80&w=1400'
    },
    {
      id: '03',
      navLabel: 'RESULTS',
      title: 'Results',
      description:
        'Provide deployment-ready datasets that improve model confidence, reduce edge-case errors, and accelerate validation cycles across enterprise and mobility AI programs.',
      image: 'https://images.unsplash.com/photo-1531973576160-7125cd663d86?auto=format&fit=crop&q=80&w=1400'
    }
  ];
  ...
  return (
    <div className="bg-[#FCFBF7]">
      <section className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-2 items-center gap-12 bg-[#F3EFDE] rounded-[3rem] p-16 relative overflow-hidden">
          <div className="relative z-10">
            <h1 className="text-7xl font-black text-[#012620] uppercase tracking-tighter mb-8 leading-none">
              Type C -
              <br />
              Vertical LLM Data
            </h1>
          ...
          <div className="relative h-[400px]">
            <img
              ...
              className="w-full h-full object-contain grayscale invert opacity-70"
              alt="Abstract shapes"
            />
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <p className="text-xl text-slate-600 font-medium mb-24 max-w-4xl">
          Autonomous driving and Smart cockpit datasets for Driver Monitoring System. China Merchants Group: Enterprise-grade dataset for building "ShipGPT".
        </p>

        <div className="text-center mb-20">
          <h2 className="text-5xl font-black text-[#012620] uppercase tracking-tighter mb-4">2D, 3D &amp; 4D Data for Autonomous Driving</h2>
          <p className="text-3xl text-slate-400 font-medium">The leading AI company in autonomous vehicle development</p>
        </div>

        <h2 className="text-4xl font-black text-[#133020] uppercase tracking-tighter mb-12">TYPE C: SOLUTIONS</h2>
